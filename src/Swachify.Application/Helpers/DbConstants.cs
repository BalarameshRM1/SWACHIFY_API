...
public static class DbConstants
{
    ...
    public readonly static string fn_users_list = "select * from fn_users_list({0},{1},{2},{3})";
      //SELECT * FROM fn_service_booking_list({tickt_id},{custid},{empid},{limit},{offset})
    public readonly static string fn_service_booking_list = "SELECT * FROM fn_service_booking_list({0},{1},{2},{3},{4})";
