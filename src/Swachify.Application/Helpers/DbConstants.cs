...
public static class DbConstants
{
    ...
    public readonly static string fn_create_master_departments = "SELECT * FROM fn_create_master_departments(p_department_id:=“{department_id}”p_department_name := “{department_name}”,p_service_id:=“{service_id}”,p_service_name := “{service_name}”,p_service_type_id:=“{service_type_id}”p_service_type := “{service_type}”,p_price := “{price}“);";
